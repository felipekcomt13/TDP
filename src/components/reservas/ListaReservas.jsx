                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                      ...
                      <p>
                        ...
                        <span className="text-black font-bold">
                          S/ {calcularPrecioReserva(reserva.cancha || 'principal', reserva.hora, reserva.horaFin, esSocio())}
                          {reserva.horaFin && (() => {
                            const desglose = obtenerDesglosePrecio(reserva.cancha || 'principal', reserva.hora, reserva.horaFin, esSocio());
                            return <span className="text-xs text-gray-600 font-normal ml-1">({desglose.numHoras}h)</span>;
                          })()}
                          {esSocio() && <span className="text-xs text-gray-600 font-normal ml-1">(Socio)</span>}
                        </span>
                      </p>
                      <p>
