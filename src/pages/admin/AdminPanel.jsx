                  ...
                  <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
                    <div className="flex-1 w-full">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 text-sm text-gray-600">
                        ...
                        <p>
                          <span className="font-semibold">Precio Ref.:</span>{' '}
                          <span className="text-black font-bold">
                            S/ {calcularPrecioReserva(reserva.cancha || 'principal', reserva.hora, reserva.horaFin, false)}
                            {reserva.horaFin && (() => {
                              const desglose = obtenerDesglosePrecio(reserva.cancha || 'principal', reserva.hora, reserva.horaFin, false);
